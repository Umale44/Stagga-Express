...
<head>
    ...
    <title>Stagga Express | The Home of express delivery | Stores | MrPrice</title>
...
<header id="theheader">
    ...
    <div class="stores-background">
        <video autoplay muted loop poster="">
            <source src="../Mr Price Banner2.mp4" type="video/mp4">
...
$sql = "SELECT * FROM product WHERE storeID = 5";
$stmt = $pdo->query($sql);
...
?>
    ...
    <h1>ELEVATE YOUR STYLE THROUGH MR PRICE</h1>
